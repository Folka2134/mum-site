      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 md:m-6'>
        <div className='border-black rounded'>
          ...
          <div className='flex flex-col items-center justify-center p-12'>
            ...
            <button className='mt-8 mb-1 p-4 text-white bg-pink-400 w-52 rounded hover:text-black hover:bg-[#BBF7D0] duration-300'>Overview</button>
            <button className='p-4 text-white bg-pink-400 w-52 rounded border-gray-200 hover:text-black hover:bg-[#BBF7D0] duration-300'>Unlock</button>
          </div>
        </div>
        <div className='rounded'>
          ...
          <div className='flex flex-col items-center p-12'>
            ...
            <button className='mt-8 mb-1 p-4 text-white bg-pink-400 w-52 rounded border-gray-200 hover:text-black hover:bg-[#BBF7D0] duration-300'>Overview</button>
            <button className='p-4 text-white bg-pink-400 w-52 rounded border-gray-200 hover:text-black hover:bg-[#BBF7D0] duration-300'>Unlock</button>
          </div>
        </div>
        <div className='rounded'>
